    ...
    experience: {
      ...
      data: {
        "1": {
          ...
          tags: ["تطوير الذكاء الاصطناعي", "البنية التحتية للأجهزة", "خط إنتاج الفيديو", "OBS", "حل مشاكل الأجهزة", "التوثيق التقني"]
        },
        "2": {
          ...
          tags: ["استراتيجية النظام البيئي", "القيادة الوظيفية المشتركة", "التواصل المؤسسي", "تنسيق البرامج"]
        },
        "3": {
          ...
          tags: ["Python", "Pandas", "أتمتة البيانات", "التوثيق التقني", "العمليات"]
        },
        "4": {
          ...
          tags: ["بنية الشبكات", "الأنظمة المدمجة", "منطق TTL", "C++", "التوجيه والتبديل"]
        }
      }
    }
  },
